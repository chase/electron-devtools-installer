...
exports.MOBX_DEVTOOLS = exports.APOLLO_DEVELOPER_TOOLS = exports.CYCLEJS_DEVTOOL = exports.REDUX_DEVTOOLS = exports.VUEJS_DEVTOOLS = exports.ANGULARJS_BATARANG = exports.JQUERY_DEBUGGER = exports.BACKBONE_DEBUGGER = exports.REACT_DEVELOPER_TOOLS = exports.EMBER_INSPECTOR = void 0;
...
const install = (extensionReference, options = {}) => {
    ...
    return downloadChromeExtension_1.default(chromeStoreID, forceDownload || false).then((extensionFolder) => {
        ...
        if (electron_1.session.defaultSession.loadExtension) {
            utils_1.removeUnrecognizedInfo(extensionFolder);
